...
export const WhatsAppLive = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const scrollThreshold = 200; // Show widget after 200px scroll
      
      // Show widget when scrolled past threshold
    ...
    if (!isPageScrollable) {
      setIsVisible(true); // Always show on non-scrollable pages
      return;
    }
      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            {/* Main button */}
            <div className="relative bg-green-500 p-3 rounded-full shadow-lg transform transition-transform duration-300 group-hover:scale-110">
              <svg
