...
const serviceLinks = [
  "/services#re-recording-mix",
  "/services#sound-design",
  "/services#audio-editing",
];

const services = copy.expertise.cards.map((card, i) => ({
  ...card,
  icon: serviceIcons[i],
  link: serviceLinks[i],
}));
  ...
  return (
    <section className="w-full py-14">
      <div className="max-w-screen-xl mx-auto px-6 md:px-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">{copy.expertise.sectionTitle}</h2>
          <div className="w-16 h-1 bg-orange-500 mx-auto mb-6"></div>
          <p className="text-gray-600 max-w-2xl mx-auto">
            {copy.expertise.sectionSubtitle}
          </p>
        </motion.div>
