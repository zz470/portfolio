...
export const socialLinks: SocialLink[] = [
  {
    name: "IMDB",
    href: "https://www.imdb.com/name/nm13638090/",
    visible: true,
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-clapperboard">
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/lorenzo-pardell/",
    visible: true,
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/lorenzopardell/",
    visible: true,
    icon: (
  ...
  },
  {
    ...
    visible: false, // Example of a toggled-off link
    icon: (
...
/**
 * Get visible social links only
 */
export function getVisibleSocialLinks(): SocialLink[] {
  return socialLinks.filter(link => link.visible);
}

/**
 * A helper function to get a specific social link by name
 */
