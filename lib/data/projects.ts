...
export const projects: Project[] = [
  ...
  {
    id: 30,
    title: "Esse é o Bicho - Season 2",
    slug: "esse-e-o-bicho",
    description: "\"Esse é o Bicho!\" é uma iniciativa da Sabiá Educacional que une audiovisual e educação ambiental para aproximar as crianças da biodiversidade que está ao nosso redor.\n\nPor meio de vídeos animados, materiais educativos e atividades nas escolas, o projeto desperta a curiosidade científica, incentiva o cuidado com a natureza e convida crianças e educadores a refletirem sobre nossa relação com o meio ambiente.",
    thumbnail_url: "/images/projects/esse_e_o_bicho_s02/esse_e_o_bicho_thumb_01.png",
    video_url: "https://www.youtube.com/watch?v=OekuFOnkJek",
    category: "Series",
    roles: ["Dialogue Editor", "Sound Effects Editor", "Sound Designer", "Re-recording Mixer"],
    production_company: "Sabiá Educacional",
    media_platform: "YouTube",
    release_date: 2026,
    hero_url: "/images/projects/esse_e_o_bicho_s02/esse_e_o_bicho_hero_01.jpg",
    design_version: "primary",
  },
  // 2025 releases
  {
